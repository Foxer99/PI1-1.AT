...
#P
canvas.create_rectangle(x + dlzka * 20, y, x + dlzka * 21, y + dlzka,fill = color_5 )
canvas.create_rectangle(x + dlzka * 21, y, x + dlzka * 22, y + dlzka,fill = color_5 )
canvas.create_rectangle(x + dlzka * 22, y, x + dlzka * 23, y + dlzka,fill = color_5 )
canvas.create_rectangle(x + dlzka * 23, y, x + dlzka * 24, y + dlzka,fill = color_5 )

canvas.create_rectangle(x + dlzka * 20, y + dlzka, x + dlzka * 21, y + dlzka * 2, fill = color_5 )
canvas.create_rectangle(x + dlzka * 20, y + dlzka * 2, x + dlzka * 21, y + dlzka * 3, fill = color_5 )
canvas.create_rectangle(x + dlzka * 20, y + dlzka * 3, x + dlzka * 21, y + dlzka * 4, fill = color_5 )
canvas.create_rectangle(x + dlzka * 20, y + dlzka * 4, x + dlzka * 21, y + dlzka * 5,fill = color_5 )
canvas.create_rectangle(x + dlzka * 20, y + dlzka * 5, x + dlzka * 21, y + dlzka * 6,fill=  color_5 )
canvas.create_rectangle(x + dlzka * 20, y + dlzka * 6, x + dlzka * 21, y + dlzka * 7,fill = color_5 )

canvas.create_rectangle(x + dlzka * 21, y + dlzka * 3, x + dlzka * 22, y + dlzka * 4,fill =color_5 )
canvas.create_rectangle(x + dlzka * 22, y + dlzka * 3, x + dlzka * 23, y + dlzka * 4,fill =color_5 )
canvas.create_rectangle(x + dlzka * 23, y + dlzka * 3, x + dlzka * 24, y + dlzka * 4,fill =color_5 )

canvas.create_rectangle(x + dlzka * 24, y + dlzka, x + dlzka * 25, y + dlzka * 2,fill =color_5)
canvas.create_rectangle(x + dlzka * 24, y + dlzka * 2, x + dlzka * 25, y + dlzka * 3,fill =color_5)
